    ...
    return (
      <Card className="gap-0 border-none bg-white py-0 shadow-sm">
        ...
        <CardContent className="pb-4">
          <p className="mb-4 text-xs text-[#3c4f3d]">
            Predict the impact of genetic variants using the Evo2 deep learning
            model.
          </p>
          <div className="flex flex-wrap items-end gap-4">
            <div>
              <label className="mb-1 block font-bold text-red-800">
                Position
              </label>
              <Input
            ...
            <div>
              <label className="mb-1 block font-bold text-yellow-600">
                Alternative (variant)
              </label>
              <Input
            ...
            <Button
              ...
              className="h-8 cursor-pointer bg-green-700 text-xs text-white hover:bg-yellow-700"
              onClick={() =>
                handleVariantSubmit(
