      ...
      <CardContent className="pb-4">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <div className="flex">
              <span className="min-28 w-28 text-l text-red-800">
                Symbol:
              </span>
              <span className="text-l">{gene.symbol}</span>
            </div>
            <div className="flex">
              <span className="min-28 w-28 text-l text-red-800">
                Name:
              </span>
              <span className="text-l">{gene.name}</span>
            </div>
            {gene.description && gene.description !== gene.name && (
              <div className="flex">
                ...
                <span className="text-l">{gene.description}</span>
              </div>
            )}
            <div className="flex">
              <span className="min-28 w-28 text-l text-red-800">
              ...
              <span className="text-l">{gene.chrom}</span>
            </div>
            {geneBounds && (
              <div className="flex">
                <span className="min-28 w-28 text-l text-red-800">
          ...
          <div className="space-y-2">
            ...
            {geneDetail?.organism && (
              <div className="flex">
                <span className="w-28 text-l text-red-800">
                  Organism:
                </span>
                <span className="text-l">
            ...
            {geneDetail?.summary && (
              <div className="mt-4">
                <h3 className="mb-2 text-l font-medium text-red-800">
                  Summary:
                </h3>
                <p className="text-l leading-relaxed text-[#3c4f3d]/80">
                  {geneDetail.summary}
                </p>
              </div>
            )}
