...
import type { ClinvarVariant, GeneBounds, GeneDetailsFromSearch } from "~/utils/genome-api";
  ...
  return (
    <Card className="gap-0 border-none bg-white py-0 shadow-sm">
      <CardHeader className="pt-4 pb-2">
        <CardTitle className="text-xl font-bold text-green-800 pb-2">
          Gene Sequence
        </CardTitle>
      </CardHeader>
        ...
        {geneBounds && (
          <div className="mb-4 flex flex-col">
            <div className="mb-2 flex flex-col items-center justify-between text-xs sm:flex-row">
              <span className="flex items-center gap-1 text-[#3c4f3d]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-[#3c4f3d]">Start:</span>
                  <Input
                    value={startPosition}
                ...
                <Button
                  ...
                  className="h-7 w-full cursor-pointer bg-green-700 text-xs text-white hover:bg-yellow-800 sm:w-auto"
                >
                  {isLoading ? "Loading..." : "Load sequence"}
                </Button>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-[#3c4f3d]">End:</span>
                  <Input
                    value={endPosition}
